...
import {removeProject} from "@shared/api/projectService";
    ...
    <>
        ...
        <div className="bg-primary dark:bg-lightGray-dark shadow sm:rounded-lg mb-4">
          <div className="px-4 py-5 sm:p-6">
            <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-primaryText-dark">Удалить проект по ID</h3>
            ...
            <form className="mt-5 flex gap-4" onSubmit={(e) => handleSubmit(e)}>
              ...
              >
                <p>Удалить проект {projectId && `с ID ${projectId}`}</p>
              </button>
            </form>
          </div>
        </div>
